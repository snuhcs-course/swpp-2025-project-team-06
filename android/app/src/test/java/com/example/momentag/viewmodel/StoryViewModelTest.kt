...
class StoryViewModelTest {
    ...
    @Test
    fun `loadStories success with stories should update state to Success`() = runTest {
        // Given
        val photoResponses = listOf(
    ...
    @Test
    fun `loadStories success with empty stories should update state to Success with empty list`() = runTest {
        // Given
    ...
    @Test
    fun `loadStories network error should update state to NetworkError`() = runTest {
        // Given
        coEvery { mockRecommendRepository.getStories(any()) } returns
    ...
    @Test
    fun `loadStories unauthorized should update state to Error`() = runTest {
        // Given
        coEvery { mockRecommendRepository.getStories(any()) } returns
    ...
    @Test
    fun `loadStories bad request should update state to Error`() = runTest {
        // Given
        coEvery { mockRecommendRepository.getStories(any()) } returns
    ...
    @Test
    fun `loadStories generic error should update state to Error`() = runTest {
        // Given
        coEvery { mockRecommendRepository.getStories(any()) } returns
    ...
    @Test
    fun `loadMoreStories success should append stories to existing list`() = runTest {
        // Given - initial stories loaded
        val initialPhotoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
        )
    ...
    @Test
    fun `loadMoreStories when not in Success state should not load`() = runTest {
        // Given - state is Idle
        // When
    ...
    @Test
    fun `loadMoreStories with empty result should set hasMore to false`() = runTest {
        // Given - initial stories loaded
        val initialPhotoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
        )
    ...
    @Test
    fun `loadMoreStories error should silently fail without changing state`() = runTest {
        // Given - initial stories loaded
        val initialPhotoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
        )
    ...
    @Test
    fun `loadTagsForStory success should update story with suggested tags`() = runTest {
        // Given - initial stories loaded
        val photoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
        )
    ...
    @Test
    fun `loadTagsForStory should not call API if tags already in cache`() = runTest {
    ...
    @Test
    fun `loadTagsForStory error should silently fail and cache empty list`() = runTest {
        // Given - initial stories loaded
        val photoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
        )
    ...
    @Test
    fun `toggleTag should add tag when not selected`() = runTest {
        // When
    ...
    @Test
    fun `toggleTag should remove tag when already selected`() = runTest {
    ...
    @Test
    fun `toggleTag should handle multiple tags for same story`() = runTest {
        // When
        viewModel.toggleTag(storyId = "story1", tag = "sunset")
    ...
    @Test
    fun `toggleTag should handle multiple stories independently`() = runTest {
        // When
        viewModel.toggleTag(storyId = "story1", tag = "sunset")
    ...
    @Test
    fun `getSelectedTags should return correct tags for story`() = runTest {
        // Given
        viewModel.toggleTag(storyId = "story1", tag = "sunset")
        viewModel.toggleTag(storyId = "story1", tag = "beach")
        advanceUntilIdle()
    ...
    @Test
    fun `getSelectedTags should return empty set for story with no tags`() = runTest {
        // When
    ...
    @Test
    fun `submitTagsForStory should handle submission`() = runTest {
        // Given
        viewModel.toggleTag(storyId = "story1", tag = "sunset")
        viewModel.toggleTag(storyId = "story1", tag = "beach")
        advanceUntilIdle()
    ...
    @Test
    fun `setCurrentIndex should update current index`() = runTest {
    ...
    @Test
    fun `setCurrentIndex should not update when not in Success state`() = runTest {
        // Given - state is Idle
        // When
        viewModel.setCurrentIndex(1)
        advanceUntilIdle()
    ...
    @Test
    fun `loadStories should emit Loading state before success`() = runTest {
        // Given
        val photoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
        )
    ...
    @Test
    fun `loadStories should set hasMore to true when result size equals requested size`() = runTest {
        // Given
        val photoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
            PhotoResponse(photoId = "photo2", photoPathId = 2L),
    ...
    @Test
    fun `loadStories should set hasMore to false when result size is less than requested size`() = runTest {
        // Given
        val photoResponses = listOf(
            PhotoResponse(photoId = "photo1", photoPathId = 1L),
        )
