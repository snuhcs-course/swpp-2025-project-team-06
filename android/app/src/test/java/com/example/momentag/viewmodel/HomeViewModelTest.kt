...
class HomeViewModelTest {
    ...
    @Test
    fun loadServerTagsErrorTest() = runTest {
    ...
    @Test
    fun loadServerTagsExceptionTest() = runTest {
    ...
    @Test
    fun deleteTagSuccessTest() = runTest {
        val tagId = "t1"
    ...
    @Test
    fun deleteTagErrorTest() = runTest {
        val tagId = "t1"
    ...
    @Test
    fun deleteTagUnauthorizedTest() = runTest {
        val tagId = "t1"
