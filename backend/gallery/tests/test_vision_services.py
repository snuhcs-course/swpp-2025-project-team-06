...
class VisionServicesTest(TestCase):
    ...
    @patch('gallery.vision_service.torch.no_grad') # Patch torch.no_grad context manager
    ...
    @patch('gallery.vision_service.get_caption_processor') # Patch your processor loader
